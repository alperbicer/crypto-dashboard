    ...
    <div class="row no-gutters coin-info">
      <div class="col-7">
        ...
        <div class="row no-gutters mt-1">
          ...
          <div class="col text-left">
            ...
            <div 
              v-if="ticker.price" 
              class="coin-price">{{ ticker.price || '' }}<span style="font-size: x-small; font-weight: 700; padding-left: 3px;">{{ info.quote }}</span></div>
          </div>
        </div>
      </div>
      <div 
      ...
      <div 
        ...
        <div 
          ...
          <span 
            class="dd-item" 
            @click="openDetails">Open</span>
          <span 
            class="dd-item" 
            @click="removeCard">Delete</span>
        </div>
      </div>
    </div>
    <div 
